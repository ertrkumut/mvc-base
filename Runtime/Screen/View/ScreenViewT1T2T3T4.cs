...
{
    public class ScreenView<TParam1, TParam2, TParam3, TParam4> : ScreenBody, IScreenView<TParam1, TParam2, TParam3, TParam4>
    {
        ...
        internal override void InitializeScreenParams(params object[] screenParams)
        {
            ...
            Param4 = (TParam4) screenParams[3];
        }
    }

    public interface IScreenView<TParam1, TParam2, TParam3, TParam4> : IScreenBody
    {
        TParam1 Param1 { get; set; }
        TParam2 Param2 { get; set; }
        TParam3 Param3 { get; set; }
        TParam4 Param4 { get; set; }
    }
}